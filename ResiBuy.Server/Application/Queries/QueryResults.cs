namespace ResiBuy.Server.Application.Queries
{
    public class QueryResults
    {
        ...
        public record StoreQueryResult(Guid Id, string Name, string Description, bool IsLocked, bool IsOpen, DateTime CreatedAt, string OwnerId,string PhoneNumber, bool IsPayFee, object Room);
        //Room query result
        ...
        public record OrderItemQueryResult(Guid Id,int ProductId, int ProductDetailId, Guid? ReviewId, string ProductName, int Quantity, decimal Price, object Image, List<AddtionalDataQueryResult> AddtionalData, List<string> Barcode);
