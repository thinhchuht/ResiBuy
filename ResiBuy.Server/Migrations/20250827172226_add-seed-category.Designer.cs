...
namespace ResiBuy.Server.Migrations
{
    ...
    [Migration("20250827172226_add-seed-category")]
            ...
            modelBuilder.Entity("ResiBuy.Server.Infrastructure.Model.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7c67c125-3ef2-4ab3-bc83-f635e0f6b3f4"),
                            Name = "Đồ điện tử",
                            Status = true
                        },
                        new
                        {
                            Id = new Guid("30afab43-160b-4404-8a9a-ed2b687f8e33"),
                            Name = "Thời trang",
                            Status = true
                        },
                        new
                        {
                            Id = new Guid("90c5e2bc-6f86-4666-a5fd-24f4199feee2"),
                            Name = "Đồ gia dụng",
                            Status = true
                        },
                        new
                        {
                            Id = new Guid("aca25380-74c9-42f3-b970-196adc95d927"),
                            Name = "Sách",
                            Status = true
                        },
                        new
                        {
                            Id = new Guid("4a653656-4a7d-4393-91b1-7e69b1d598b9"),
                            Name = "Thể thao",
                            Status = true
                        },
                        new
                        {
                            Id = new Guid("a451ae9f-7b8f-4afe-acbf-7b48dfa4b0e0"),
                            Name = "Mỹ phẩm",
                            Status = true
                        },
                        new
                        {
                            Id = new Guid("2f111d52-30fb-473c-a6e0-0d14ae3928f3"),
                            Name = "Đồ chơi",
                            Status = true
                        },
                        new
                        {
                            Id = new Guid("dfbb8122-75e1-416f-bfec-1d86f584acc4"),
                            Name = "Thực phẩm",
                            Status = true
                        },
                        new
                        {
                            Id = new Guid("7828cd00-8dce-4a7c-a383-7e32a067a994"),
                            Name = "Phụ kiện",
                            Status = true
                        },
                        new
                        {
                            Id = new Guid("68d0ac89-16d1-4ba2-b471-503443a0fe48"),
                            Name = "Nội thất",
                            Status = true
                        });
                });
            ...
            modelBuilder.Entity("ResiBuy.Server.Infrastructure.Model.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "cf09859b-6c6c-4816-9811-f459bb813e42",
                            CategoryId = new Guid("7c67c125-3ef2-4ab3-bc83-f635e0f6b3f4"),
                        ...
                        new
                        {
                            Id = "10cdbee3-051f-423f-961d-0e6dc9f633c5",
                            CategoryId = new Guid("30afab43-160b-4404-8a9a-ed2b687f8e33"),
                            Name = "thoitrang.jpg",
                        ...
                        new
                        {
                            Id = "e7cb6354-bbc9-48b1-b7f0-11c790d8211d",
                            CategoryId = new Guid("90c5e2bc-6f86-4666-a5fd-24f4199feee2"),
                            Name = "dogiadung.jpg",
                        ...
                        new
                        {
                            Id = "ace0984c-16bd-4a83-9a89-81e425c13907",
                            CategoryId = new Guid("aca25380-74c9-42f3-b970-196adc95d927"),
                            Name = "sach.jpg",
                        ...
                        new
                        {
                            Id = "17acb302-b70d-46d9-a21f-3b271be51c41",
                            CategoryId = new Guid("4a653656-4a7d-4393-91b1-7e69b1d598b9"),
                            Name = "thethao.jpg",
                        ...
                        new
                        {
                            Id = "075fef74-e60e-4d68-bb60-0997995a9d7d",
                            CategoryId = new Guid("a451ae9f-7b8f-4afe-acbf-7b48dfa4b0e0"),
                            Name = "mypham.jpg",
                        ...
                        new
                        {
                            Id = "c647fe00-90fb-4ab2-a138-67b16b5bd17f",
                            CategoryId = new Guid("2f111d52-30fb-473c-a6e0-0d14ae3928f3"),
                            Name = "dochoi.png",
                        ...
                        new
                        {
                            Id = "822f7d86-6f31-4a79-935d-c71ecad5a7bf",
                            CategoryId = new Guid("dfbb8122-75e1-416f-bfec-1d86f584acc4"),
                            Name = "thucpham.jpg",
                        ...
                        new
                        {
                            Id = "06ae626a-0899-4a38-8f1b-0316202c4428",
                            CategoryId = new Guid("7828cd00-8dce-4a7c-a383-7e32a067a994"),
                            Name = "phukien.jpg",
                        ...
                        new
                        {
                            Id = "c7c992e6-5806-4b54-8a57-59c5b438250b",
                            CategoryId = new Guid("68d0ac89-16d1-4ba2-b471-503443a0fe48"),
                            Name = "noithat.jpg",
            ...
            modelBuilder.Entity("ResiBuy.Server.Infrastructure.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "adm_df",
                            CreatedAt = new DateTime(2025, 8, 28, 0, 22, 23, 664, DateTimeKind.Local).AddTicks(2783),
                            DateOfBirth = new DateTime(1990, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@123",
                            FullName = "Administrator",
                            IdentityNumber = "admin",
                            IsLocked = false,
                            PasswordHash = "$2a$11$7jEfnrteiybasZx5dL2TKewuqpvOEVHCokVP2mQ2eV6M9IWoMkmyK",
                            PhoneNumber = "admin",
                            ReportCount = 0,
                            Roles = "[\"ADMIN\"]",
                            UpdatedAt = new DateTime(2025, 8, 28, 0, 22, 23, 664, DateTimeKind.Local).AddTicks(2797)
                        });
                });
