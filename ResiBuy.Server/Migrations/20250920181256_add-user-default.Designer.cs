...
namespace ResiBuy.Server.Migrations
{
    ...
    [Migration("20250920181256_add-user-default")]
    partial class adduserdefault
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ResiBuy.Server.Infrastructure.Model.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2f7e2a63-b98f-42f6-88c5-0356db3a7001"),
                            Name = "Đồ điện tử",
                            Status = true
                        },
                        new
                        {
                            Id = new Guid("4c950812-85a8-4e50-a16a-30429808ba9e"),
                            Name = "Thời trang",
                            Status = true
                        },
                        new
                        {
                            Id = new Guid("54683f1c-9291-4881-8d34-d32a2e183278"),
                            Name = "Đồ gia dụng",
                            Status = true
                        },
                        new
                        {
                            Id = new Guid("56fe6a3f-fcb0-4e5a-93a5-cf2b7bd6cd7a"),
                            Name = "Sách",
                            Status = true
                        },
                        new
                        {
                            Id = new Guid("0b5e51fb-e9c5-4410-927e-f5ec2c2190af"),
                            Name = "Thể thao",
                            Status = true
                        },
                        new
                        {
                            Id = new Guid("e0865a50-74f8-40b3-b62d-81ddc324fa17"),
                            Name = "Mỹ phẩm",
                            Status = true
                        },
                        new
                        {
                            Id = new Guid("1710e3c1-bcda-4a8b-bad7-91472ea1d4bd"),
                            Name = "Đồ chơi",
                            Status = true
                        },
                        new
                        {
                            Id = new Guid("b916b4f7-5bbc-4749-952f-3aa502ebf413"),
                            Name = "Thực phẩm",
                            Status = true
                        },
                        new
                        {
                            Id = new Guid("3fce639a-2a02-4099-b207-1722fc7432fc"),
                            Name = "Phụ kiện",
                            Status = true
                        },
                        new
                        {
                            Id = new Guid("b1bf396a-3751-45b9-bec5-e5e543ce7563"),
                            Name = "Nội thất",
                            Status = true
                        },
                        new
                        {
                            Id = new Guid("951eb5e0-e711-4bb5-b105-ecde8435cba6"),
                            Name = "Khác",
                            Status = true
                        });
                });
            ...
            modelBuilder.Entity("ResiBuy.Server.Infrastructure.Model.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "87e2e581-1ebf-4e4a-a38b-0a955aabc758",
                            CategoryId = new Guid("2f7e2a63-b98f-42f6-88c5-0356db3a7001"),
                        ...
                        new
                        {
                            Id = "d7fb4c2c-da86-40cb-8a6d-7c4b38bb8f60",
                            CategoryId = new Guid("4c950812-85a8-4e50-a16a-30429808ba9e"),
                            Name = "thoitrang.jpg",
                        ...
                        new
                        {
                            Id = "ed5ee8e1-ede1-4703-b0a0-7b13a979a134",
                            CategoryId = new Guid("54683f1c-9291-4881-8d34-d32a2e183278"),
                            Name = "dogiadung.jpg",
                        ...
                        new
                        {
                            Id = "462f3688-9988-4a3b-9729-5b43a30fd96d",
                            CategoryId = new Guid("56fe6a3f-fcb0-4e5a-93a5-cf2b7bd6cd7a"),
                            Name = "sach.jpg",
                        ...
                        new
                        {
                            Id = "bec3af53-865d-4821-a9b0-1c3f52ee5536",
                            CategoryId = new Guid("0b5e51fb-e9c5-4410-927e-f5ec2c2190af"),
                            Name = "thethao.jpg",
                        ...
                        new
                        {
                            Id = "89984d4c-fe67-4a33-9379-ba09fe3ac6d8",
                            CategoryId = new Guid("e0865a50-74f8-40b3-b62d-81ddc324fa17"),
                            Name = "mypham.jpg",
                        ...
                        new
                        {
                            Id = "32853fda-1ab8-4e4f-9e55-46f5549c45fb",
                            CategoryId = new Guid("1710e3c1-bcda-4a8b-bad7-91472ea1d4bd"),
                            Name = "dochoi.png",
                        ...
                        new
                        {
                            Id = "148ac057-6e6a-4ac8-900b-5f5f4125a63b",
                            CategoryId = new Guid("b916b4f7-5bbc-4749-952f-3aa502ebf413"),
                            Name = "thucpham.jpg",
                        ...
                        new
                        {
                            Id = "06f5ee3c-506b-48b9-a63e-9800cbc26374",
                            CategoryId = new Guid("3fce639a-2a02-4099-b207-1722fc7432fc"),
                            Name = "phukien.jpg",
                        ...
                        new
                        {
                            Id = "a1dec1e9-fea4-436e-852a-e262d12e62b7",
                            CategoryId = new Guid("b1bf396a-3751-45b9-bec5-e5e543ce7563"),
                            Name = "noithat.jpg",
                        ...
                        new
                        {
                            Id = "eb3d68d6-0bef-4695-9841-5afb555bbd36",
                            CategoryId = new Guid("951eb5e0-e711-4bb5-b105-ecde8435cba6"),
                            Name = "khac1.jpg",
            ...
            modelBuilder.Entity("ResiBuy.Server.Infrastructure.Model.Promotion", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Discount = 0,
                            EndDate = new DateTime(2225, 9, 21, 1, 12, 54, 878, DateTimeKind.Local).AddTicks(5013),
                            IsActive = false,
                            Name = "No Promotion",
                            StartDate = new DateTime(2025, 9, 21, 1, 12, 54, 878, DateTimeKind.Local).AddTicks(5012)
                        });
                });
            ...
            modelBuilder.Entity("ResiBuy.Server.Infrastructure.Model.Store", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 9, 21, 1, 12, 54, 878, DateTimeKind.Local).AddTicks(5008),
            ...
            modelBuilder.Entity("ResiBuy.Server.Infrastructure.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "adm_df",
                            CreatedAt = new DateTime(2025, 9, 21, 1, 12, 54, 878, DateTimeKind.Local).AddTicks(4672),
                            DateOfBirth = new DateTime(1990, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@123",
                            FullName = "Administrator",
                            IdentityNumber = "admin",
                            IsLocked = false,
                            PasswordHash = "$2a$11$jkzsMbBUpkIxt5ydetnzR.W3XffNaYq/97EcR9sI5Dxa.7.FOUDoG",
                            PhoneNumber = "admin",
                            ReportCount = 0,
                            Roles = "[\"ADMIN\"]",
                            UpdatedAt = new DateTime(2025, 9, 21, 1, 12, 54, 878, DateTimeKind.Local).AddTicks(4689)
                        },
                        new
                        {
                            Id = "55555555-5555-5555-5555-555555555555",
                            CreatedAt = new DateTime(2025, 9, 21, 1, 12, 55, 33, DateTimeKind.Local).AddTicks(217),
                            DateOfBirth = new DateTime(2000, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "user@resibuy.local",
                            FullName = "Khách vãng lai",
                            IdentityNumber = "000000000000",
                            IsLocked = false,
                            PasswordHash = "$2a$11$1Y9Ihb0GicJu1ptcqNqCJOhxGknliQjMPHFCA1JSIadeU9.aXerJm",
                            PhoneNumber = "0123456789",
                            ReportCount = 0,
                            Roles = "[\"CUSTOMER\"]",
                            UpdatedAt = new DateTime(2025, 9, 21, 1, 12, 55, 33, DateTimeKind.Local).AddTicks(234)
                        });
                });
