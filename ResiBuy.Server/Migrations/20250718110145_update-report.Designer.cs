...
namespace ResiBuy.Server.Migrations
{
    ...
    [Migration("20250718110145_update-report")]
            ...
            modelBuilder.Entity("ResiBuy.Server.Infrastructure.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "adm_df",
                            CreatedAt = new DateTime(2025, 7, 18, 18, 1, 44, 959, DateTimeKind.Local).AddTicks(3874),
                            ...
                            IsLocked = false,
                            PasswordHash = "$2a$11$LZZmIvGgIDag4iHjusATv.IljNpAweFLrp5u9cVMS65VPwJkVkfVi",
                            PhoneNumber = "admin",
                            PhoneNumberConfirmed = true,
                            Roles = "[\"ADMIN\"]",
                            UpdatedAt = new DateTime(2025, 7, 18, 18, 1, 44, 959, DateTimeKind.Local).AddTicks(3886)
                        });
                });
