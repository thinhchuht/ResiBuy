namespace ResiBuy.Server.Infrastructure.Model
{
    public class Order
    {
        ...
        {
            Id = id;
            TotalPrice = totalPrice > 5000 ? totalPrice : throw new CustomException(ExceptionErrorCode.ValidationFailed, "Đơn hàng phải có giá trị tối thiểu 5000Đ.") ;
            Status = OrderStatus.Pending;
            PaymentStatus = paymentMethod == PaymentMethod.COD ?  PaymentStatus.Pending : PaymentStatus.Paid;
            PaymentMethod = paymentMethod;
            CreateAt = DateTime.Now;
            UpdateAt = DateTime.Now;
            Note = note.Length > 100 ? throw new CustomException(ExceptionErrorCode.ValidationFailed, "Ghi chú không được quá 100 ký tự.") : note;
