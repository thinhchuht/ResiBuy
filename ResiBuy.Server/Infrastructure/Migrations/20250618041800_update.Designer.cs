...
namespace ResiBuy.Server.Infrastructure.Migrations
{
    ...
    [Migration("20250618041800_update")]
            ...
            modelBuilder.Entity("ResiBuy.Server.Infrastructure.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "adm_df",
                            CreatedAt = new DateTime(2025, 6, 18, 11, 18, 0, 346, DateTimeKind.Local).AddTicks(8705),
                            ...
                            IsLocked = false,
                            PasswordHash = "$2a$11$WC82WSQtBSzIPVSBHp3FjeLHOYI1QBmfP3/ziGEjlIgIIPA5njZUm",
                            PhoneNumber = "admin",
                            PhoneNumberConfirmed = true,
                            Roles = "[\"ADMIN\"]",
                            UpdatedAt = new DateTime(2025, 6, 18, 11, 18, 0, 346, DateTimeKind.Local).AddTicks(8720)
                        });
                });
