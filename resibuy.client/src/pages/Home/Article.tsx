  ...
  return (
    <Box
      sx={{
        ...
        width: "80%",
        mx: "auto",
        borderRadius: "16px", // Rounded corners for youthful style
      }}
    >
      {/* Left section: Images */}
      <Box sx={{ display: "flex", gap: 2, marginRight: 5 }}>
        ...
        <Box
          sx={{
            ...
            justifyContent: "center",
            alignItems: "center",
            backgroundImage: `url('https://neonix-demo.myshopify.com/cdn/shop/files/close-up-food-complements-with-orange_zcopy.jpg?v=1745291465&width=1100')`, // Placeholder image
            backgroundSize: "cover",
            backgroundPosition: "center",
          }}
        ></Box>
      ...
      <Box sx={{ maxWidth: "40%" }}>
        <Typography
          variant="overline"
          sx={{ color: "#007bff", fontWeight: "bold", letterSpacing: "1px" }}
        >
        ...
        <Typography variant="body1" sx={{ color: "#666", mb: 3 }}>
          ...
          audio devices. Engineered with advanced acoustic technology and sleek
          modern design, each speaker delivers crystal-clear sound and powerful
          bass. Whether at home or on the go, experience immersive audio like
          never before.
        </Typography>
