...
import { Star, ShoppingCart, Visibility, FavoriteBorder } from "@mui/icons-material";
...
const FeaturedProduct = () => {
  ...
  const productActions = [
    ...
    {
      icon: <FavoriteBorder sx={{ color: '#FF6B6B', fontSize: 22 }} />,
  ...
  return (
    ...
    >
      <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 2 }}>
        ...
        <Link to={"/products"} style={{ textDecoration: "none", color: "#FF6B6B", fontWeight: 500, fontSize: "1rem" }}>
          Xem thêm
        </Link>
      </Box>
      <Box
        ...
        {products.map((product) => (
          ...
          >
                ...
                >
                  {productActions.map((action, idx) => (
                    <Box
                      ...
                      onClick={(e) => { e.preventDefault(); action.onClick(product); }} 
            ...
            <Box sx={{ display: "flex", alignItems: "center", gap: 0.8, justifyContent: "center", mb: 0.2 }}>
              <Typography sx={{ color: "#FF6B6B", fontWeight: 600, fontSize: "1.05rem" }}>
                {product.price.toLocaleString(undefined, { maximumFractionDigits: 2 })}đ
              </Typography>
              {product.discount > 0 && (
                <Typography
                  variant="body2"
