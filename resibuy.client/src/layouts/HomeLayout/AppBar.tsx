        ...
        <MuiAppBar
            ...
            <Toolbar sx={{justifyContent: "space-between"}}>
                ...
                <Box
                    ...
                    <Box onMouseEnter={handleHomeMenuOpen} onMouseLeave={handleHomeMenuClose}
                ...
                <Box sx={{display: "flex", alignItems: "center", gap: 2}}>
                    <SearchBase value={searchValue} onChange={handleSearchChange} onSearch={handleSearch}
                                sx={{width: "300px"}} inputSx={{width: "100%"}}/>
                    {user && (
